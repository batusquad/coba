            ...
            <form onSubmit={saveUser}>
                <div className="field">
                    ...
                    <div className="control">
                        <input type="text" className="input" value={dokumen} onChange={(e => setDokumen(e.target.value))} placeholder='nama'/>
                    </div>
                </div>
                <div className="field">
                    <label className="label">Nama Pegawai</label>
                    <div className="control">
                        <input type="text" className="input" value={namapegawai} onChange={(e => setNamapegawai(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input type="text" className="input" value={maksudperjalanandinas} onChange={(e => setMaksudperjalanandinas(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                    <label className="label">Angkutan</label>
                    <div className="control">
                        <input type="text" className="input" value={angkutan} onChange={(e => setAngkutan(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                    <label className="label">Tempat Berangkat</label>
                    <div className="control">
                        <input type="text" className="input" value={tempatberangkat} onChange={(e => setTempatberangkat(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                    <label className="label">Tempat Tujuan</label>
                    <div className="control">
                        <input type="text" className="input" value={tujuan} onChange={(e => setTujuan(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                    <label className="label">Lama Perjalanan Dinas</label>
                    <div className="control">
                        <input type="text" className="input" value={estimasiwaktu} onChange={(e => setEstimasiwaktu(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                    <label className="label">Tanggal Berangkat</label>
                    <div className="control">
                        <input type="text" className="input" value={tanggalberangkat} onChange={(e => setTanggalberangkat(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                    <label className="label">Tanggal Harus Kembali/Tiba di Tempat Baru</label>
                    <div className="control">
                        <input type="text" className="input" value={tanggalharuskembali} onChange={(e => setTanggalharuskembali(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input type="text" className="input" value={tanggallahir} onChange={(e => setTanggallahir(e.target.value))} placeholder='name'/>
                        <input type="text" className="input" value={tanggallahir} onChange={(e => setTanggallahir1(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                    ...
                    <div className="control">
                        ...
                        <input type="text" className="input" value={keterangan1} onChange={(e => setKeterangan1(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input type="text" className="input" value={nomordivisi} onChange={(e => setNomordivisi(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                    <label className="label">ketlainlain</label>
                    <div className="control">
                        <input type="text" className="input" value={ketlainlain} onChange={(e => setKetlainlain(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
