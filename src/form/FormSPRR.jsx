        ...
        <div className="column is-half">
            <form onSubmit={saveUser}>
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input type="text" className="input" value={rapat} onChange={(e => setRapat(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                    <label className="label">lantai</label>
                    <div className="control">
                        <input type="text" className="input" value={lantai} onChange={(e => setLantai(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input type="text" className="input" value={tanggalrapat} onChange={(e => setTanggalrapat(e.target.value))} placeholder='name'/>
                    </div>
                </div>
                <div className="field">
